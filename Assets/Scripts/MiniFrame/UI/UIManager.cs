...
namespace MiniFrame.UI
{
    ...
    public class UIManager : Singleton<UIManager>
    {
        ...
        public UIManager()
        {
            ...
            ResourcesManager.Instance.LoadAssetAsync<GameObject>("Canvas", (handle) =>
            {
        ...
        public void ShowPanel<T>(string panelName, E_UI_Layer layer = E_UI_Layer.Mid, UnityAction<T> callBack = null) where T : BasePanel
        {
            ...
            else
            {
                ...
                ResourcesManager.Instance.LoadAssetAsync<GameObject>(panelName, (handle) =>
                {
