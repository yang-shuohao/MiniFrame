...
namespace YSH.Framework.Editor
{
    ...
    public class FindObjectsUsingScript
    {
        ...
        {
            Debug.Log("<color=green>==========Objects using script " + scriptName + " in the Hierarchy==========</color>");
            ...
            Debug.Log("<color=green>==========Objects using script " + scriptName + " in the Project==========</color>");
